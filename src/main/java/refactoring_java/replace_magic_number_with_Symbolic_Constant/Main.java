...
public class Main {
	...
	private static void beforeMain() {
		...
		refactoring_java.replace_magic_number_with_Symbolic_Constant.before.Robot robot = new refactoring_java.replace_magic_number_with_Symbolic_Constant.before.Robot(
				"Andrew");
